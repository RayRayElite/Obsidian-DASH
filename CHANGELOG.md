...
1. add a new version heading here
2. summarize the user-visible changes only
3. call out migrations, known risks, or setup changes when relevant
4. mirror the same short summary into the GitHub release notes