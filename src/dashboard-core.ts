...
export function sanitizeSettings(settings: DashboardSettings): DashboardSettings {
  ...
  return {
    ...
    knowledgeBaseConceptsFolder: normalizeFolderPath(settings.knowledgeBaseConceptsFolder?.trim() || DEFAULT_SETTINGS.knowledgeBaseConceptsFolder),
    knowledgeBaseIndexesFolder: normalizeFolderPath(settings.knowledgeBaseIndexesFolder?.trim() || DEFAULT_SETTINGS.knowledgeBaseIndexesFolder),
    knowledgeBaseOutputsFolder: normalizeFolderPath(settings.knowledgeBaseOutputsFolder?.trim() || DEFAULT_SETTINGS.knowledgeBaseOutputsFolder),
    knowledgeBaseAssetsFolder: normalizeFolderPath(settings.knowledgeBaseAssetsFolder?.trim() || DEFAULT_SETTINGS.knowledgeBaseAssetsFolder),
    ...
    kanbanBoardNotesFolder: normalizeFolderPath(settings.kanbanBoardNotesFolder?.trim() || DEFAULT_SETTINGS.kanbanBoardNotesFolder),
    kanbanPluginCompatibilityMode: settings.kanbanPluginCompatibilityMode ?? DEFAULT_SETTINGS.kanbanPluginCompatibilityMode,
    kanbanAutoSyncEnabled: settings.kanbanAutoSyncEnabled ?? DEFAULT_SETTINGS.kanbanAutoSyncEnabled,
